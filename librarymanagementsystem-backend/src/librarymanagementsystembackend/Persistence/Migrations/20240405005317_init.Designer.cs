            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("8cc264f7-0827-4be5-a167-3ff0407208ce"),
                            AuthenticatorType = 0,
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Email = "narch@kodlama.io",
                            PasswordHash = new byte[] { 80, 57, 5, 204, 67, 253, 157, 24, 161, 155, 78, 118, 198, 255, 7, 28, 160, 231, 219, 12, 228, 224, 94, 62, 59, 161, 83, 84, 52, 245, 157, 117, 121, 54, 29, 17, 8, 221, 249, 73, 237, 102, 70, 38, 62, 52, 148, 227, 47, 178, 104, 70, 54, 184, 135, 225, 143, 216, 28, 109, 97, 122, 221, 215 },
                            PasswordSalt = new byte[] { 158, 133, 61, 147, 155, 99, 250, 101, 235, 112, 206, 39, 153, 15, 113, 190, 9, 101, 252, 0, 96, 3, 113, 84, 172, 56, 163, 251, 180, 29, 242, 103, 69, 57, 31, 89, 32, 164, 184, 132, 161, 26, 190, 72, 85, 34, 76, 55, 4, 22, 78, 40, 37, 126, 142, 184, 57, 54, 237, 7, 206, 125, 106, 173, 67, 0, 118, 111, 152, 184, 222, 20, 239, 113, 174, 15, 190, 230, 164, 139, 167, 108, 90, 52, 208, 208, 231, 98, 141, 91, 18, 200, 136, 183, 57, 15, 200, 210, 162, 15, 205, 115, 168, 29, 223, 229, 205, 125, 55, 114, 172, 150, 145, 126, 165, 213, 237, 199, 1, 244, 186, 173, 146, 170, 17, 222, 85, 243 }
                        });
                });
            ...
            modelBuilder.Entity("Domain.Entities.UserOperationClaim", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a1c5763-ae11-46e0-996d-e0b55df3ee26"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            OperationClaimId = 1,
                            UserId = new Guid("8cc264f7-0827-4be5-a167-3ff0407208ce")
                        });
                });
