...
public class UpdateFavoriteListMaterialCommand : IRequest<UpdatedFavoriteListMaterialResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
