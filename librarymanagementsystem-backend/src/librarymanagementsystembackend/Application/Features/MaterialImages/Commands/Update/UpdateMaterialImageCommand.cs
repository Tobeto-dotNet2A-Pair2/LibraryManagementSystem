...
public class UpdateMaterialImageCommand : IRequest<UpdatedMaterialImageResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
