...
public class DeleteTranslatorMaterialCommand : IRequest<DeletedTranslatorMaterialResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
