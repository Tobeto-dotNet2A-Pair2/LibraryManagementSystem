...
public class UpdateTranslatorMaterialCommand : IRequest<UpdatedTranslatorMaterialResponse>, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest //ISecuredRequest,
{
