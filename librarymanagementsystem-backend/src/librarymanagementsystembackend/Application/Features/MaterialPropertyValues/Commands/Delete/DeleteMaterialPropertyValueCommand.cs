...
public class DeleteMaterialPropertyValueCommand : IRequest<DeletedMaterialPropertyValueResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
