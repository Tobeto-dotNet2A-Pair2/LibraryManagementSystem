...
public class UpdateMaterialGenreCommand : IRequest<UpdatedMaterialGenreResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
