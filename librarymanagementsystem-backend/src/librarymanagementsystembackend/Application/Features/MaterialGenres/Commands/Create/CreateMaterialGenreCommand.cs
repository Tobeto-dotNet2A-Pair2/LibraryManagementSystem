...
public class CreateMaterialGenreCommand : IRequest<CreatedMaterialGenreResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
