...
public class DeleteMaterialCopyCommand : IRequest<DeletedMaterialCopyResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
