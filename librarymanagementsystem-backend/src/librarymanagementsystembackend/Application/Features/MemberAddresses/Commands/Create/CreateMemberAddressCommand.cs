...
public class CreateMemberAddressCommand : IRequest<CreatedMemberAddressResponse>, ISecuredRequest, ICacheRemoverRequest, ILoggableRequest, ITransactionalRequest
{
